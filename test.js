...
// ==================================================
// section-05 페이드인 애니메이션 시작
// ==================================================
gsap.to(".sec5-container", {
  scrollTrigger: {
    trigger: ".section-05",
    start: "top 70%", // 섹션이 화면 아래에서 30% 정도 올라왔을 때 실행
  },
  opacity: 1,
  y: 0,
  duration: 1,
...
// ==================================================
// section-06 페이드인 애니메이션 시작
// ==================================================
gsap.to(".sec6-container", {
  scrollTrigger: {
    trigger: ".section-06",
    start: "top 70%", // 화면의 70% 지점에 닿았을 때 실행
  },
  opacity: 1,
  y: 0,
  duration: 1,
...
// ==================================================
// iframe(지도) 위에서 커스텀 커서 숨기기
// ==================================================
const mapArea = document.querySelector('.sec6-map');

if (mapArea) {
  // 지도 영역에 마우스가 들어가면 하얀 동그라미 숨김
  mapArea.addEventListener('mouseenter', () => {
    gsap.to(cursor, { scale: 0, opacity: 0, duration: 0.2 });
  });
  // 지도 영역에서 마우스가 나오면 하얀 동그라미 다시 나타남
